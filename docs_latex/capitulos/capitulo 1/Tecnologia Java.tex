...
\begin{figure}[ht] % Entorno flotante para posicionar
	
	\centering
	\includegraphics[width=0.5\textwidth]{capitulos/capitulo 1/Imagenes/jvm.png}
\end{figure}
...
Bien empecemos con un codigo basico. Este ejemplo solo enviara a la consola un mensaje que dice "Hola Java"


\begin{lstlisting}[caption=Ejemplo de código Java]
